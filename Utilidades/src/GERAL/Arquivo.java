...
public class Arquivo {
    ...
    /**
    *   Faz a leitura de um arquivo específico. Use este método
    *   para recuperar SOMENTE a primeira linha de um arquivo
    ...
    *   
    ...
    /**
    *   Este método SOBREESCREVE todo o conteúdo do arquivo
    *   designado e escreve SOMENTE o conteúdo da String informada.
    *   Utilize este método com muito cuidado, uma vez que ele apaga
    *   o conteúdo anterior do arquivo.
    * 
    *   @author Mateus Garcia
    *   @param path caminho para o arquivo especificado
    ...
    *   linha-a-linha, gera um ArrayList de String, contendo todas
    *   as linhas do arquivo respeitando suas posições, mantendo
    *   o index do ArrayList igual ao numero da linha, começando por 0.
    *   Use este método se você quer uma lista com as linhas do arquivo
    * 
    ...
    *   
    ...
    /**
    *   Faz a leitura de um arquivo específico buscando por uma linha 
    *   que começe com a String informada como Codigo.
    *   Se o arquivo contiver mais de uma linha que começe com o
    *   Código informado, ele lancará uma Exception informando
    *   esta ocorrência.
    *   Este método foi desenvolvido para ser utilizado para leitura de
    *   Arquivos de configuração genéricos.
    *   Utilize este método se você deseja ler o conteúdo de apenas uma
    *   linha específica dentro de um arquivo e sabe como esta linha se inicia.
    * 
    ...
    *   Este método é similar e oposto ao método getLineByCode. 
    *   O método varre o arquivo designado, localizando a linha que começa
    *   com o código informado. Ao localizar esta linha, o conteudo da mesma
    *   é SOBREESCRITO mantendo-se apenas o código inicial, somado do
    *   conteúdo informado no parametro.
    *   Assim como o getLineByCode, este método também foi desenvolvido
    *   para trabalhar com arquivos de configuração genéricos, salvando
    *   as configurações do usuário para serem recuperadas mais tarde
    *   pelo getLineByCode.
    *   #####################################<br>
    *   <strong>CUIDADO</strong><br>
    *   #####################################<br>
    *   Este método SOBREESCREVE o conteúdo da linha designada pelo código.
    *   Utilize este método com cautela.
    *   Use este método se você deseja configurar o conteúdo de uma linha
    *   especifica do arquivo
    * 
    *   @author Mateus Garcia
    *   @param path caminho para o arquivo especificado
    ...
    *   retirada de um arquivo qualquer por outros métodos) e verifica
    *   qual é o primeiro caractere válido desta linha.<br>
    *   Este método foi desenvolvido para auxiliar a leitura de arquivos 
    *   de configuração genéricos, com o objetivo de saber se a linha
    *   analisada é um comentário ou uma linha de código válida.<br>
    *   O método que invocar este, saberá se a linha é um comentário.<br>
    *   Utilize este método se você deseja saber se a linha informada é 
    *   um comentário.
    * 
    *   @param linha String representando uma linha de um arquivo qualquer
    *   @param coment Char indicador de comentários
    *   @return Retorna um boolean informando se a linha se inicia com
    *   o caractere informado. TRUE se sim, FALSE se não.
    *   @author Mateus Garcia
    *   
     */
    public static boolean IsAComent(String linha, char coment) {
     ...
     /**
    *   Método que ADICIONA uma linha no FINAL do arquivo informado.
    *   Utilize este método para escrever um conteúdo no final de um 
    *   arquivo sem alterar o conteúdo anterior.
    *   @author Mateus Garcia
    *   @param path caminho para o arquivo especificado
    ...
    *   
    ...
    public static void AddThisLineAtEOF(String path, String texto) throws IOException {
     ...
     /**
    *   Método que ADICIONA uma linha no INICIO do arquivo informado.
    *   Utilize este método para escrever um conteúdo no começo de um 
    *   arquivo sem alterar o conteúdo adiante.
    *   @author Mateus Garcia
    *   @param path caminho para o arquivo especificado
    ...
    *   sequência de caractéres válida encontrada na linha, e termina no
    *   primeiro espaço encontrado após o primeiro conteúdo.<br>
    *   Utilize este método se você deseja saber qual é a primeira palavra 
    *   de uma frase.
    *   @author Mateus Garcia
